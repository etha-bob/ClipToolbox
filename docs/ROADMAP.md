...
| M9 | Focus + crop compatibility (Ethan 2026-07-16) — Tab focus works with crop on: crop toolbar stays usable inside focus (preview/edit, add/delete, key nav, reset, clear) and the crop box drags in Edit mode; C inside focus toggles crop without leaving focus. Supersedes B5's mutual-exclusion decision | — | todo |
